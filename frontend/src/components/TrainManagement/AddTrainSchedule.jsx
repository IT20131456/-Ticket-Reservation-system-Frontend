...
export default function AddTrainSchedule() {
    ...
    const [seatClassesArray, setSeatClassesArray] = useState(["First-Class", "Second-Class"]);
    ...
    const onSubmit = (e) => {
        ...
        const updateIntermediateStopsArray = () => {
          ...
          const stopsArray = intermediate_stops.split(',').map(stop => stop.trim());
      ...
      <div className="content-column m-3 mt-5">
        <Container className="shadow pt-2 pb-2 bg-white mt-4 border rounded">
          <Form className="mt-2 p-3">
            <div className="row">
              <h4 className="text-center text-success">Add New Train Schedule</h4>
